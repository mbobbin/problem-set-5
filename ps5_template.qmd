...
shp_path = r"C:\\Users\\Mitch\\Documents\\GitHub\\problem-set-5\\cb_2018_us_state_500k.zip"

state_geo_data=gpd.read_file(shp_path)

state_actions_df=scraped_data_df[scraped_data_df["Category"]=="State Enforcement Agencies"]
#clean the agency column so we can extract the state:
...
#Change this name since it'll be easier to merge values later
#for our geo df
state_actions_df["state"] = np.where(
...
state_geo_data_totals.plot(column="Count",legend="Count")
